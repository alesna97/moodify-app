...
public class recommendedAdapterActivity1 extends RecyclerView.Adapter<recommendedAdapterActivity1.RecommendedViewHolder> {

    private ArrayList<RecommendedModel> dataList;
    private Context context;
    LayoutInflater inflater;
    public recommendedAdapterActivity1 (ArrayList<RecommendedModel> dataList, Context context){
    ...
    @NonNull
    @Override
    public recommendedAdapterActivity1.RecommendedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.list_recommended, parent, false);
        return new recommendedAdapterActivity1.RecommendedViewHolder(view);
    }

    @Override
    public void onBindViewHolder(recommendedAdapterActivity1.RecommendedViewHolder holder, int position) {
